...
main()
{
int x,produk1=10000,produk2=20000,produk3=15000,jumlah1,jumlah2,jumlah3,total,bayar,tunai,sisa,diskon;
string barang1,barang2,barang3;

	   cout<<"============================================"<<endl;
	   cout<<"  Program Kasir Sederhana Zul Fahmi Auzan"<<endl;
	   cout<<"============================================"<<endl;
	   cout<<endl;
			...
			cout<<"Masukkan Nama Produk 3		: "; cin>>barang3;
			cout<<"Jumlah Produk			: ";
			cin>>x;
			jumlah3=x*produk3;
			cout<<"Total Harga			: Rp. "<<jumlah3<<endl;cout<<endl; 

			bayar=jumlah1+jumlah2+jumlah3;
			cout<<endl; 
			cout<<"============================================"<<endl;
